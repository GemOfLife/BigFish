...
SRCS = benchmark.cpp bitboard.cpp evaluate.cpp learn.cpp main.cpp \
...
CXXFLAGS = $(ENV_CXXFLAGS) -Wall -Wcast-qual -fno-exceptions -march=native -std=c++17 $(EXTRACXXFLAGS)
